...
FORM_SCHEMAS = {
    ...
    18: {
        ...
        "sections": [
            {"name": "Vehicle Info", "fields": ["vehicle_no", "type", "colour", "manufacture_date", "sticker_no"]},
            {"name": "EMV", "checklist": ["Horn", "Wipers", "Mirrors", "Seat belts", "Lights"]},
            {"name": "Electrical", "checklist": ["Battery secure", "No exposed wiring", "Indicators", "Reverse alarm"]},
            {"name": "Leakages", "checklist": ["Fuel leak", "Oil leak", "Hydraulic leak"]},
            {"name": "Safety/Braking", "checklist": ["Parking brake", "Service brake", "Extinguisher", "First aid", "Wheel chocks"]},
            {"name": "Specialized Equipment", "checklist": ["GSE coupling", "Stability", "Emergency shutdown"]},
        ],
    },
    19: {
